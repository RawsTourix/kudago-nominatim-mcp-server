...
class ListsSearchHandler:
    ...
    async def run(
        ...
        search_result = await self.lists_service.search_lists(
            job_id=context.job_id,
            location=location,
            tags=payload.get("tags"),
    ...
    def _geo_message(status: str) -> str:
        ...
        return "KudaGo lists endpoint requires a KudaGo location slug."
